...
var GoogleCardLayout2 = /** @class */ (function () {
    ...
    GoogleCardLayout2 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'google-card-layout-2',template:/*ion-inline-start:"/var/www/html/surjeet-project1/mobile/src/components/list-view/google-card/layout-2/google-card.html"*/'<!--Theme Google Card - Styled cards 2-->\n\n<ion-content padding-top>\n\n<ion-grid no-padding>\n\n  <ion-row *ngIf="data != null">\n\n    <ion-col col-12 col-lg-4 *ngFor="let item of data.items;let i = index">\n\n      <ion-card text-left box-shadow margin-bottom padding>\n\n          <img [src]="item.image" />\n\n        <ion-card-content no-padding margin-top (click)="onEvent(\'onItemClick\', item, $event)">\n\n            <h2 card-title text-capitalize>{{item.title}}</h2>\n\n            <h1 card-subtitle>{{item.subtitle}}</h1>\n\n        </ion-card-content>\n\n      </ion-card>\n\n    </ion-col>\n\n  </ion-row>\n\n</ion-grid>\n\n</ion-content>\n\n'/*ion-inline-end:"/var/www/html/surjeet-project1/mobile/src/components/list-view/google-card/layout-2/google-card.html"*/
        }),
