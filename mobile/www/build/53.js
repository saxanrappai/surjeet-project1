...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__drag_and_drop_layout_3__ = __webpack_require__(807);
...
var DragAndDropLayout3 = /** @class */ (function () {
    ...
    DragAndDropLayout3 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'drag-and-drop-layout-3',template:/*ion-inline-start:"C:\wamp64\www\surjeet-project1\mobile\src\components\list-view\drag-and-drop\layout-3\drag-and-drop.html"*/'<!-- Themes Drag and drop - Medium item with avatar-->\n\n<ion-content>\n\n  <ion-grid no-padding *ngIf="data != null">\n\n    <ion-row>\n\n      <ion-col col-12>\n\n        <!-- Header Medium item with avatar-->\n\n        <ion-list-header no-lines header-section no-margin>\n\n          <h1 header-title text-capitalize>{{data.header}}</h1>\n\n        </ion-list-header>\n\n        <!-- Content Medium Item With Avatar-->\n\n        <ion-list no-margin item-divider reorder="true" (ionItemReorder)="reorderItems($event)">\n\n          <ion-item item-divider no-lines *ngFor="let item of data.items; let i = index;"\n\n          (click)="onEvent(\'onItemClick\', item.title, $event)">\n\n            <!--Avatar-->\n\n            <ion-avatar item-start>\n\n              <img [src]="item.image">\n\n            </ion-avatar>\n\n            <!--Title-->\n\n            <h2 item-title>{{item.title}}</h2>\n\n            <!--Subtitle-->\n\n            <h3 item-subtitle>{{item.subtitle}}</h3>\n\n          </ion-item>\n\n        </ion-list>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\wamp64\www\surjeet-project1\mobile\src\components\list-view\drag-and-drop\layout-3\drag-and-drop.html"*/
        }),
