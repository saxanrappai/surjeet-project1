...
var CardReaderLayout1 = /** @class */ (function () {
    ...
    CardReaderLayout1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'card-reader-layout-1',template:/*ion-inline-start:"C:\wamp64\www\surjeet-project1\mobile\src\components\card-reader\layout-1\card-reader.html"*/'<!--Theme Scanner - Click here-->\n\n<ion-content has-header>\n\n  <div *ngIf="data != null">\n\n  <ion-item *ngIf="data.cardType">\n\n    {{data.cardType}}\n\n  </ion-item>\n\n  <ion-item *ngIf="data.redactedCardNumber">\n\n    {{data.redactedCardNumber}}\n\n  </ion-item>\n\n  <ion-item *ngIf="data.cardNumber">\n\n    {{data.cardNumber}}\n\n  </ion-item>\n\n  <ion-item *ngIf="data.expiryMonth">\n\n    {{data.expiryMonth}}\n\n  </ion-item>\n\n  <ion-item *ngIf="data.expiryYear">\n\n    {{data.expiryYear}}\n\n  </ion-item>\n\n  <ion-item *ngIf="data.cvv">\n\n    {{data.cvv}}\n\n  </ion-item>\n\n  <ion-item *ngIf="data.postalCode">\n\n    {{data.postalCode}}\n\n  </ion-item>\n\n  <ion-item *ngIf="data.cardholderName">\n\n    {{data.cardholderName}}\n\n  </ion-item>\n\n</div>\n\n</ion-content>'/*ion-inline-end:"C:\wamp64\www\surjeet-project1\mobile\src\components\card-reader\layout-1\card-reader.html"*/
        }),
