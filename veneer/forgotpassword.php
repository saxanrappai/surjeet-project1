                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                              <form method="post" action="forgotpassword_success.php">
                                <div class="card card-login card-hidden">
                                    <div class="card-header text-center" data-background-color="rose">
									    <h3 class="card-title" style="line-height:3px">Forgot Password<h3>
                                        <h4 ></h4>
                                    </div>
                                    ...
                                    <div class="card-content">
                                        <div class="input-group">
                                            ...
                                            <div class="form-group label-floating">
                                                <input type="email" name="email" pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$" class="form-control" placeholder="Enter your email" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer text-center">
                                        <button type="submit" class="btn btn-rose btn-simple btn-wd btn-lg">Send Mail</button>
                                    </div>
                                </div>
                            </form>
                        </div>
