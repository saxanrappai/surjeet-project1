...
$to = $_REQUEST['email']; 
$actual_link = "https://{$_SERVER['HTTP_HOST']}/resetpassword.php?email=".$to.""; //Recording file live serer URL base path       
$email = "accounts@lakud.com";       
$subject = "Reset Your Account Password";
$msg = "Please click this <a href=".$actual_link.">link</a> to reset your myshop account password";

    $headers = "MIME-Version: 1.0" . "\r\n";
    $headers .= "Content-type:text/html;charset=iso-8859-1" . "\r\n";
    $headers .= 'From: Reset Password '. $email . "\r\n" .
				"CC: allappyogi@zippr.app";
    
    		
    if (mail($to, $subject, $msg, $headers)) {
        $errmsg = "Your mail has been sent";
    } else {
    ...
    <div class="wrapper wrapper-full-page">
        <div class="full-page login-page" filter-color="black" data-image="new_theme/assets/img/login.jpg">
            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                             <p><?php  echo $errmsg; ?> <br> Please check your email to reset password</p>        
                    </div>
                </div>
            </div>
        </div>
