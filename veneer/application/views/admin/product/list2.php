                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a class="pull-right" href="<?php echo site_url("admin/add_products"); ?>" style="margin:  0px 10px;padding: 0px 10px;border: 1px solid; ">ADD</a>
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    if($showImage!=""){ ?><div class="cat-img" style="width:35px;margin:auto"><img width="50px" height="50px" src="<?php echo $this->config->item('base_url').'uploads/products/'.$showImage; ?>" /></div> <?php } ?></td>
