                                        ...
                                        <div class="row">
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                  <?php
                                                    $arrayTitles=array();
                                                    $qs = $this->db->query("Select title from categories;");
                                                    $result = $qs->result();
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    ...
                                                    <div class="thumbnail" id="image_preview" ></div>
                                                    <div>
                                                        ...
                                                        <a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput" onclick = "clickedRemove()" ><i class="fa fa-times"></i> Remove All</a>
                                                    </div>
                                                </div>
    ...
    $(document).ready(function() {
     ...
     $(document).on("click", "a.remove" , function() {
        ...
        function preview_image() 
        {
         ...
         {
          $('#image_preview').append("<img id='"+i+"' src='"+URL.createObjectURL(event.target.files[i])+"'/> <button type=\"button\" class=\"btn btn-default btn-sm\" id='"+i+"' onclick=\"removeItem(this.id)\"> <span class=\"glyphicon glyphicon-remove\"></span> Remove </button>");
         }
        }
...
function addcountries(arrayvalue){
    countries = arrayvalue;
