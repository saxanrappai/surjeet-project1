                                                            ...
                                                            if (strpos($product->product_image, '[') !== false) {
                                                                ...
                                                                if(count($imgs)>0){
                                                                     ...
                                                                     foreach($imgs as $imgItem){
                                                                        ...
                                                                        <div style=" float: left;  width: 15%;margin:10px" id="<?php echo $imgItem ?>"> 
                                                                            ...
                                                                            <img style="height:150px;" src="<?php echo 'http://lakud.com/uploads/products/'.$imgItem ?>" id="<?php echo $imgItem ?>"/>
                                                             ...
                                                             ?>
                                                              ...
                                                              <div style=" float: left;  width: 15%;margin:10px" id="<?php echo $product->product_image ?>">
                                                                 ...
                                                                 <img style="height:150px;" src="<?php echo 'http://lakud.com/uploads/products/'.$product->product_image?>" id="<?php echo $product->product_image ?>" />
