                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Add Product</h4>
                                                ...
                                                <div class="row form-group label-floating is-empty search-container" id="category_search">
                                                    <div class="col-md-11">
                                                        <label class="control-label"></label>
                                                            ...
                                                            <div class="form-group label-floating is-empty">
                                                                <label class="control-label"></label>
                                                                 <input id="myInput" type="text" name="category" class="form-control" placeholder="Select Category">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group label-floating is-empty">
                                                                <label class="control-label"></label>
                                                                <input type="text" name="size[]"  class="form-control" placeholder="11x22"/>
                                                            <span class="material-input"></span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    ...
                                                    <div class="row" style="max-width:80%" id="image_preview" ></div>
                                                    <div>
                                                        <span class="btn btn-rose btn-round btn-file" id="add_image">
                                                            <span class="fileinput-new" id="add_more">Add image</span>
                                                            <span class="fileinput-exists" id="add_more">Add image</span>
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <textarea name="product_description" class="textarea" style="width: 100%; height: 50px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd;  "></textarea>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-1">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                <input type="radio" name="prod_status" value="1"  checked/><label>In Stock</label>
                                                <span class="material-input"></span></div>
                                            </div>
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                <input type="radio" name="prod_status"  value="0" /><label>Deactive</label>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">TAX (%) : </label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                        ...
                                        <div class="row" style="display: none;">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="unit" class="form-control" placeholder="KG/ BAG/ NOS/ QTY / etc " value="QTY" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row" style="display: none;">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="rewards" class="form-control" placeholder="00" value="0"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
    ...
    $(document).ready(function() {
     ...
     $(document).on("click", "a.remove" , function() {
        ...
        function preview_image() 
        {
         ...
         {
           $('#image_preview').append(" <div style=\" float: left; width: 15%;margin:10px\" id='"+i+"'> <img style=\"height:150px; \" id='"+i+"' src='"+URL.createObjectURL(event.target.files[i])+"'/> <button type=\"button\" class=\"btn btn-default btn-sm\" id='"+i+"' onclick=\"removeItem(this.id)\"> <span class=\"glyphicon glyphicon-remove\"></span>  </button> </div>");
         }
        }
