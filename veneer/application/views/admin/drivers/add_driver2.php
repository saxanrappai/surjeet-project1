                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Add Driver </h4>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Driver Name : *</label>
                                            <div class="col-md-9">
                                         ...
                                         <div class="row">
                                            <label class="col-md-3 label-on-left">Vehicle Number : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="driver_vehicle_no" class="form-control" placeholder="Vehicle Number" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
