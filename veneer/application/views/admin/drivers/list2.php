                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a class="pull-right" href="<?php echo site_url("admin/add_driver"); ?>">ADD DRIVER</a>
                                    <div class="toolbar">
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php foreach($drivers as $driver){ ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo $driver->driver_name; ?></td>
                                                        <td class="text-center"><?php echo $driver->driver_vehicle_no; ?></td>
                                                        <td class="text-center"><?php echo $driver->driver_phone; ?></td>
                                                        <td class="text-center">
                                                            <div class="togglebutton">
                                                                <input type="checkbox" data-table="driver" data-status="driver_status" data-idfield="driver_id"  data-id="<?php echo $driver->driver_id; ?>" id='cb_<?php echo $driver->driver_id; ?>' type='checkbox' <?php echo ($driver->driver_status==1)? "checked" : ""; ?> disabled/>
                                                                <label class='tgl-btn' for='cb_<?php echo $driver->driver_id; ?>'>
                                                        ...
                                                        <td class="td-actions text-center"><div class="btn-group">
                                                            ...
                                                            <?php echo anchor('admin/edit_driver/'.$driver->driver_id, '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                                <i class="material-icons">edit</i>
                                                            </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/delete_driver/'.$driver->driver_id, '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
