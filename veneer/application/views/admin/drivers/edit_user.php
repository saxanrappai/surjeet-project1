...
<html>
  ...
  <input type="text" class="form-control" id="user_fullname" value="<?php echo $user->user_fullname; ?>"
   name="user_fullname" placeholder="User Full Name" />
                                    </div>
     ...
     <input type="text" class="form-control" id="user_fullname" value="<?php echo $user->user_name; ?>"
                   ...
                   <option value="<?php echo $user->user_phone; ?>">  <?php echo $user->user_city; ?></option>
