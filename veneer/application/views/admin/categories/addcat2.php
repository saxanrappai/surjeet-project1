                                    ...
                                    <h4 class="card-title">Add Categories</h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="width:35%">
                                                    <img src="" alt="">
                                                </div>
                                                <div class="fileinput-preview fileinput-exists thumbnail" style="width:35%"></div>
                                                <div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                <input type="radio" name="cat_status" value="1" class="col-md-3" checked/><label class="col-md-6">Active</label>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                <input type="radio" name="cat_status" value="0" class="col-md-3" /><label class="col-md-6">Deactive</label>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" class="btn btn-fill btn-rose" name="addcatg" value="Add Category">
                                                </div>
                                            </div>
                                        </div>
                                </div>
