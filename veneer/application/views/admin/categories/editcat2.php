                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Edit Categories</h4>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Categories Title *</label>
                                            <div class="col-md-9">
                                                ...
                                                <div class="row form-group label-floating is-empty search-container" id="category_search">
                                                    <div class="col-md-11">
                                                        <label class="control-label"></label>
                                                            ...
                                                            <div class="form-group label-floating is-empty">
                                                                <label class="control-label"></label>
                                                                 <input id="myInput" type="text" name="category" class="form-control" placeholder="Select Category" value="<?php if($parent!=null){echo $parent->title;}?>">
                                                    ...
                                                    <select class="text-input form-control" name="category_selection" onchange="getval(this);">
                                                        ...
                                                        <?php  
                                                           for($x=0;$x<=count($arrayTitles);$x++){
                                                                ...
                                                                $leval = $arrayleval[$x];
                                                            ?>
                                                           <option value="<?php echo $title?>" <?php if(($parent!=null) && ($parent->title == $title)){echo 'selected';}?>> <?php 
                                                           for($y=1;$y<=$leval;$y++){
                                                               echo '_';
                                                           }
                                                           echo $title;?></option>
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Categories Image </label>
                                            <div class="col-md-9">
                                                <legend></legend>
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail" id="image_preview" style="width:35%">
                                                        <?php
                                                            if($getcat->image !=null){
                                                                $img = $getcat->image;
                                                                ?>
                                                                 <img width="35%" height="35%" src="<?php echo $this->config->item('base_url').'uploads/category/'.$getcat->image ?>" />
                                                    ...
                                                    <div class="fileinput-preview fileinput-exists thumbnail" id="image_preview1" style="width:35%"></div>
                                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                <input type="radio" name="cat_status" value="1"  <?php if($getcat->status == 1){ echo 'checked=""'; } ?> class="col-md-3"/><label class="col-md-6">Active</label>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                <input type="radio" name="cat_status" value="0" <?php if($getcat->status == 0){ echo 'checked=""'; } ?> class="col-md-3"/><label class="col-md-6">Deactive</label>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" class="btn btn-fill btn-rose" name="savecat" value="Save Category">
                                                </div>
                                            </div>
                                        </div>
                                </div>
