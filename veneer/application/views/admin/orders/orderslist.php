...
<html>
  ...
  <ul class="dropdown-menu">
    <li><a href="<?php  if($order->status != 3){
    
                echo site_url("admin/cancle_order/".$order->sale_id); ?>"> <?php echo $this->lang->line("Cancel");?></a></li>
        <?php }else if($order->status == 0){
                        echo "<li><a href='".site_url("admin/confirm_order/".$order->sale_id)."'>Confirm</a></li>";
                    }else if($order->status == 1){
                        echo "<li><a href='".site_url("admin/delivered_order/".$order->sale_id)."'>Out for Delivery</a></li>";
                    } 
                    else if($order->status == 2){
