                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Add Store</h4>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" name="user_fullname" class="form-control" placeholder="Store Name" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Employee Name</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="emp_fullname" class="form-control" placeholder="Employee Name" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Mobile No: *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                            ...
                                                            <select name="user_type" id="selection" class="form-control" onchange="selectedItem(this.value)">
                                                               <?php 
                                                                ...
                                                                foreach($sData as $type){ ?>
                                                                  <option value="<?php echo $type->user_type_id.'&'.$type->user_type_text ?>"><?php echo $type->user_type_title; ?></option>   
                                                            <?php    }
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">App Status</label>
                                            <div class="col-md-9">
                                                <div class="checkbox">
                                                    <label>
