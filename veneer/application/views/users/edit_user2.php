                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Edit Store </h4>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Store Name : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="user_fullname" class="form-control" placeholder="User Full Name" value="<?php echo $user->user_fullname; ?>" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Owner Name</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="emp_fullname" class="form-control" placeholder="Employee Name" value="<?php echo $user->user_name; ?>" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" value="<?php echo $user->user_phone; ?>" name="mobile" placeholder="Mobile No" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Addresss : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" value="<?php echo $user->user_city; ?>" name="address" placeholder="Address" />
                                                  
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">User Email </label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" type="password" value="<?php echo $user->user_password; ?>"  name="user_password" placeholder="password" />
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                         <div class="row" style="margin-bottom:10px;">
                                             <?php
                                                     ...
                                                     <div class="col-md-9">
                                                        <div class="form-group label-floating is-empty">
                                                            <select name="user_type" id="selection" class="form-control" onchange="selectedItem(this.value)">
                                                               <?php 
                                                                
                                                                foreach($sData as $type){ ?>
                                                                  <option value="<?php echo $type->user_type_id.'&'.$type->user_type_text ?>"   <?php echo $user->user_login_type == $type->user_type_id ? 'selected="selected"' : '' ?> > <?php echo $type->user_type_title; ?></option>   
                                                            <?php    }
                                                            ...
                                                            <div id="type_text" style="color:red">*</div>
                                                    </div>
                                                    
                                        </div>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Profile Image</label>
                                            <div class="fileinput text-center fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail img-circle" id="image_preview">
                                                    <img id="<?php echo $user->user_image ?>" src="<?php echo $this->config->item('base_url').'uploads/profile/'.$user->user_image ?>" alt="">
                                                     <input type="hidden" name="user_image_pre" class="form-control" value="<?php echo $user->user_image; ?>" />
                                                </div>
                                                <div class="fileinput-preview fileinput-exists thumbnail img-circle" id="image_preview1"></div>
                                                <div>
                                                    ...
                                                    <a href="#pablo" class="btn btn-danger btn-round" onclick = "clickedRemove()" id="removeall"><i class="fa fa-times"></i> Remove<div class="ripple-container"><div class="ripple ripple-on ripple-out" style="left: 58.6719px; top: 35px; background-color: rgb(255, 255, 255); transform: scale(15.5488);"></div></div></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row" style="margin-top:50px !important">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                   <button type="submit" class="btn btn-round btn-rose" > Update User </button>
                                                </div>
                                            </div>
                                        </div>
                                </div>
    ...
    $(document).ready(function() {
     ...
     $(document).ready(function() {
      var e = document.getElementById("selection");
        ...
        console.log(s);
        var s1 = s.split('&');
        document.getElementById('type_text').innerHTML += s1[1];
      });
